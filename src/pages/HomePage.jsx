        ...
        <Container>
          <Row className="header-box d-flex align-items-center pt-lg-5">
            <Col lg="6">
              ...
              <p className="nb-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nisi, a!</p>
              <button className="btn btn-danger btn-lg rounded-1 me-2 mb-xs-0 mb-2 " onClick={() => navigate('/kelas')}>Lihat Kelas</button>
              <button className="btn btn-outline-danger btn-lg rounded-1 mb-xs-0 mb-2">Lihat Promosi</button>
            </Col>
        ...
        <Container>
          <Row>
            <Col>
              ...
              <p className="text-center">Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur, hic.</p>
            </Col>
          </Row>
          <Row>
